export const translations = {
    en: {
        common: {
            ...
            pollutantStatisticHelp: 'Choose value in order to see the statistics of the past week',
            aboutMeContent: 'Hey there, my name is Aleksandar Trenchevski, but everybody calls me Trenche, so you can \
            ...
            descriptionContent: 'AQRA - Air Quality REST API predicts air pollution using regression models based on \
    ...
    mk: {
        common: {
            ...
            pollutantStatisticHelp: 'Одберете загадувач за дa видите статисктичка состојба за изминатата недела',
            aboutMeContent: 'Здраво! Јас сум Александар Тренчевски, но сите ме викаат Тренче, па можете и вие. \
      ...
      на апликацијата и REST API-то за да може да отпочнат и сопствени апликации',
            descriptionContent: 'Air Quality REST API предвидува воздушно загадување со помош на регресивни модели \
